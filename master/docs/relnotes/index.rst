...
- :bb:reporter:`IRC` maybeColorize is able to highlight single words and stop
  colorization at the end. The previous implementation only stopped
...
- :bb:reporter:`IRC` appends the builderURL to a successful/failed build if
  available
